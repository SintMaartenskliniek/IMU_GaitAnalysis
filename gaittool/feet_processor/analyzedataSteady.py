...
from ..helpers.gaitphasefunctions import InitialSwing, PreSwing, MidSwing, TerminalSwing, LoadingResponse, \
    TerminalStance, MidStance
...
def analyzedataSteady(data, showfigure,removeSteps):
    ...
    # data['Left foot']['Original Gait Events'] = dict()
    # data['Right foot']['Original Gait Events'] = dict()
    # data['Left foot']['Original Gait Phases'] = dict()
    # data['Right foot']['Original Gait Phases'] = dict()
    # data['Left foot']['Orginal Gait Events']['Terminal Contact'] = idxTOleft
    # data['Right foot']['Orginal Gait Events']['Terminal Contact'] = idxTOright
    # data['Left foot']['Orginal Gait Events']['Mid-Swing Onset'] = idxOnsMSwleft
    # data['Right foot']['Orginal Gait Events']['Mid-Swing Onset'] = idxOnsMSwright
    # data['Left foot']['Orginal Gait Events']['Terminal-Swing Onset'] = idxOnsTSwleft
    # data['Right foot']['Orginal Gait Events']['Terminal-Swing Onset'] = idxOnsTSwright
    # data['Left foot']['Orginal Gait Events']['Initial Contact'] = idxHSleft
    # data['Right foot']['Orginal Gait Events']['Initial Contact'] = idxHSright
    # data['Left foot']['Orginal Gait Events']['Mid-Stance Onset'] = idxOnsMStleft
    # data['Right foot']['Orginal Gait Events']['Mid-Stance Onset'] = idxOnsMStright
    # data['Left foot']['Orginal Gait Events']['Heel Off'] = idxHOleft
    # data['Right foot']['Orginal Gait Events']['Heel Off'] = idxHOright
    # data['Left foot']['Orginal Gait Events']['Pre-Swing Onset'] = idxOnsPSwleft
    # data['Right foot']['Orginal Gait Events']['Pre-Swing Onset'] = idxOnsPSwright
    # data['Left foot']['Orginal Gait Phases']['Initial-Swing'] = idxISwleft
    # data['Right foot']['Orginal Gait Phases']['Initial-Swing'] = idxISwright
    # data['Left foot']['Orginal Gait Phases']['Mid-Swing'] = idxMSwleft
    # data['Right foot']['Orginal Gait Phases']['Mid-Swing'] = idxMSwright
    # data['Left foot']['Orginal Gait Phases']['Terminal-Swing'] = idxTSwleft
    # data['Right foot']['Orginal Gait Phases']['Terminal-Swing'] = idxTSwright
    # data['Left foot']['Orginal Gait Phases']['Loading Response'] = idxLRleft
    # data['Right foot']['Orginal Gait Phases']['Loading Response'] = idxLRright
    # data['Left foot']['Orginal Gait Phases']['Mid-Stance'] = idxMStleft
    # data['Right foot']['Orginal Gait Phases']['Mid-Stance'] = idxMStright
    # data['Left foot']['Orginal Gait Phases']['Terminal-Stance'] = idxTStleft
    # data['Right foot']['Orginal Gait Phases']['Terminal-Stance'] = idxTStright
    # data['Left foot']['Orginal Gait Phases']['Pre-Swing'] = idxPSwleft
    # data['Right foot']['Orginal Gait Phases']['Pre-Swing'] = idxPSwright
